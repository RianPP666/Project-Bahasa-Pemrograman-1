 ...
 * @author Rian
 */
public class PostTest3alah extends javax.swing.JFrame {

    /**
     * Creates new form BP1_M4_Rian
     */
    public PostTest3alah() {
        initComponents();
    }
    ...
    // Ambil teks dari field sebelum dibersihkan
    User = jTextField1.getText();
    Pass = jTextField2.getText();
    
    // Cek apakah username atau password kosong
    if(User.isEmpty() || Pass.isEmpty()){
        JOptionPane.showMessageDialog(null,"Username atau Password Kosong ", "Error Message", JOptionPane.ERROR_MESSAGE );
    } else {
        JOptionPane.showMessageDialog(null, "Register Berhasil", "Register Message", JOptionPane.INFORMATION_MESSAGE);
        
        // Bersihkan fields setelah register berhasil
        jTextField1.setText("");
        jTextField2.setText("");
    }
}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PostTest3alah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PostTest3alah().setVisible(true);
            }
        });
    }
